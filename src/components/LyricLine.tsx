      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            >
              <div
                className="relative flex flex-col gap-2 items-center bg-white p-6 shadow-lg max-w-lg w-full"
              ...
              >
                ...
                <h3 className="text-2xl">AI Annotation</h3>
                {annotation === "" ? (
                  <Loader />
                ) : (
                  <div className="text-gray-700 p-3 flex flex-col gap-4">
